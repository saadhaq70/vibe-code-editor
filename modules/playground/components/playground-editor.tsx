...
export const PlaygroundEditor = ({
  ...
  const handleEditorDidMount = (editor: any, monaco: Monaco) => {
    ...
    // Primary: Ctrl+. (works on all platforms, avoids zoom conflict on Mac)
    editor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyCode.Period, () => {
      console.log("Ctrl+. pressed, triggering suggestion")
      onTriggerSuggestion("completion", editor)
    })

    // Alternative: Ctrl+Space (may conflict with Spotlight on Mac)
  ...
  useEffect(() => {
    return () => {
      ...
      // Note: Monaco's addCommand doesn't return a disposable
